...
mod test {
    ...
    fn test_no_dst() -> Result<(), TzError> {
        ...
        let transition_rule_result = TransitionRule::Fixed(LocalTimeType { ut_offset: -36000, is_dst: false, time_zone_designation: Some("HST".into()) });
    ...
    fn test_quoted() -> Result<(), TzError> {
        ...
        let transition_rule_result = TransitionRule::Alternate {
            std: LocalTimeType { ut_offset: -10800, is_dst: false, time_zone_designation: Some("-03".into()) },
            dst: LocalTimeType { ut_offset: 10800, is_dst: true, time_zone_designation: Some("+03".into()) },
    ...
    fn test_full() -> Result<(), TzError> {
        ...
        let transition_rule_result = TransitionRule::Alternate {
            std: LocalTimeType { ut_offset: 43200, is_dst: false, time_zone_designation: Some("NZST".into()) },
            dst: LocalTimeType { ut_offset: 46800, is_dst: true, time_zone_designation: Some("NZDT".into()) },
    ...
    fn test_negative_dst() -> Result<(), TzError> {
        ...
        let transition_rule_result = TransitionRule::Alternate {
            std: LocalTimeType { ut_offset: 3600, is_dst: false, time_zone_designation: Some("IST".into()) },
            dst: LocalTimeType { ut_offset: 0, is_dst: true, time_zone_designation: Some("GMT".into()) },
    ...
    fn test_negative_hour() -> Result<(), TzError> {
        ...
        let transition_rule_result = TransitionRule::Alternate {
            std: LocalTimeType { ut_offset: -10800, is_dst: false, time_zone_designation: Some("-03".into()) },
            dst: LocalTimeType { ut_offset: -7200, is_dst: true, time_zone_designation: Some("-02".into()) },
    ...
    fn test_all_year_dst() -> Result<(), TzError> {
        ...
        let transition_rule_result = TransitionRule::Alternate {
            std: LocalTimeType { ut_offset: -18000, is_dst: false, time_zone_designation: Some("EST".into()) },
            dst: LocalTimeType { ut_offset: -14400, is_dst: true, time_zone_designation: Some("EDT".into()) },
